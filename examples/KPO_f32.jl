...
x_initial = Matrix{Float32}([xx yy]')

# ∨ errors due to KLUFactorization not compatible with Float32
...
# @btime $sgmam($sys, $x_initial_f32, iterations=100, ϵ=10e2, show_progress=false) # 25.803 ms (29024 allocations: 105.69 MiB)
